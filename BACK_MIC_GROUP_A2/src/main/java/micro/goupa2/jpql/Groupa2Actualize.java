...
public class Groupa2Actualize {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
       ...
       Microsergropa2 microsergropa2 = em.find(Microsergropa2.class,2);
                        System.out.println("=============Before Updation========");  
                        System.out.println("Microservice id = "+ microsergropa2.getMicroA2());  
       ...
       log.debug("Object recovered from the database:" + microsergropa2); 

       
       //the value (SETvalue) that is set to the new (object Value) 
       System.out.println("====================Object that will be actualized============================");
       microsergropa2.setMicroA2(4);
                        System.out.println("=============After Updation=========="); 
                        System.out.println("Microservice actualize id = "+ microsergropa2.getMicroA2());
       ...
       log.debug("Object actualize in the Microservice databse:" + microsergropa2);
